...
const std::vector<uint16_t> indices_data = {0,1,2,2,3,0};

static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_7*>(glfwGetWindowUserPointer(window));
...
bool app_7::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_7::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_7::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_7::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_7::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
void app_7::updateUniformBuffer(uint32_t currentImage) {
...
bool app_7::isSuitableDevice(VkPhysicalDevice& device) {
...
app_7::QueueFamilyIndices app_7::findQueueFamilies(VkPhysicalDevice device) {
    app_7::QueueFamilyIndices indices_ret;
...
void app_7::createLogicalDevice() {
...
bool app_7::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_7::SwapChainSupportDetails app_7::querySwapChainSupport(VkPhysicalDevice device) {
    app_7::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_7::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_7::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_7::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_7::createDescriptorSetLayout() {
...
void app_7::createDescriptorPool() {
...
void app_7::createDescriptorSets() {
...
void app_7::createGraphicsPipeline() {
    auto vertShaderCode = readFile("shaders/vert3.spv");
...
VkShaderModule app_7::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_7::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_7::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_7::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
...
VkCommandBuffer app_7::beginSingleTimeCommands() {
...
void app_7::endSingleeTimeCommands(VkCommandBuffer commandBuffer) {
...
void app_7::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
...
void app_7::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void app_7::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView app_7::createImageView(VkImage image, VkFormat format) {
...
void app_7::createTextureImageView() {
    textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB);
}

void app_7::createTextureSampler() {
...
void app_7::createUniformBuffers() {
...
void app_7::createCommandBuffer() {
...
void app_7::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
