...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_4*>(glfwGetWindowUserPointer(window));
...
bool app_4::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_4::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_4::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_4::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_4::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
bool app_4::isSuitableDevice(VkPhysicalDevice& device) {
...
app_4::QueueFamilyIndices app_4::findQueueFamilies(VkPhysicalDevice device) {
    app_4::QueueFamilyIndices indices_ret;
...
void app_4::createLogicalDevice() {
...
bool app_4::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_4::SwapChainSupportDetails app_4::querySwapChainSupport(VkPhysicalDevice device) {
    app_4::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_4::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_4::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_4::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_4::createGraphicsPipeline() {
...
VkShaderModule app_4::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_4::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_4::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_4::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void app_4::createCommandBuffer() {
...
void app_4::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
