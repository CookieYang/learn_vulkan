...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_5*>(glfwGetWindowUserPointer(window));
...
bool app_5::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_5::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_5::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_5::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_5::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
void app_5::updateUniformBuffer(uint32_t currentImage) {
...
bool app_5::isSuitableDevice(VkPhysicalDevice& device) {
...
app_5::QueueFamilyIndices app_5::findQueueFamilies(VkPhysicalDevice device) {
    app_5::QueueFamilyIndices indices_ret;
...
void app_5::createLogicalDevice() {
...
bool app_5::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_5::SwapChainSupportDetails app_5::querySwapChainSupport(VkPhysicalDevice device) {
    app_5::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_5::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_5::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_5::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_5::createDescriptorSetLayout() {
...
void app_5::createGraphicsPipeline() {
...
VkShaderModule app_5::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_5::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_5::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_5::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void app_5::createUniformBuffers() {
...
void app_5::createCommandBuffer() {
...
void app_5::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
