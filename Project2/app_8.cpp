...
const std::vector<uint16_t> indices_data = {0,1,2,2,3,0,4,5,6,6,7,4};

static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_8*>(glfwGetWindowUserPointer(window));
...
VkFormat app_8::findSupportedFormat(const std::vector<VkFormat>&
...
VkFormat app_8::findDepthFormat() {
...
bool app_8::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_8::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_8::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_8::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_8::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
void app_8::updateUniformBuffer(uint32_t currentImage) {
...
bool app_8::isSuitableDevice(VkPhysicalDevice& device) {
...
app_8::QueueFamilyIndices app_8::findQueueFamilies(VkPhysicalDevice device) {
    app_8::QueueFamilyIndices indices_ret;
...
void app_8::createLogicalDevice() {
...
bool app_8::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_8::SwapChainSupportDetails app_8::querySwapChainSupport(VkPhysicalDevice device) {
    app_8::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_8::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_8::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_8::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_8::createDescriptorSetLayout() {
...
void app_8::createDescriptorPool() {
...
void app_8::createDescriptorSets() {
...
void app_8::createGraphicsPipeline() {
...
VkShaderModule app_8::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_8::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_8::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_8::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
...
VkCommandBuffer app_8::beginSingleTimeCommands() {
...
void app_8::endSingleeTimeCommands(VkCommandBuffer commandBuffer) {
...
void app_8::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
...
void app_8::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void app_8::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView app_8::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void app_8::createTextureImageView() {
    textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB,VK_IMAGE_ASPECT_COLOR_BIT);
}

void app_8::createTextureSampler() {
...
void app_8::createTextureImage() {
    int width, height, channels;
    stbi_uc* pixels = stbi_load("textures/texture1.jpg", &width, &height, &channels, STBI_rgb_alpha);
...
void app_8::createDepthResources() {
...
void app_8::createIndexBuffer() {
    VkDeviceSize bufferSize = sizeof(indices_data[0])* indices_data.size();
    ...
    void* data;
    vkMapMemory(device, stagingBufferMem, 0, bufferSize, 0, &data);
    memcpy(data, indices_data.data(), (size_t)bufferSize);
    vkUnmapMemory(device, stagingBufferMem);
...
void app_8::createUniformBuffers() {
...
void app_8::createCommandBuffer() {
...
void app_8::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
    ...
    vkCmdDrawIndexed(commandBuffer, (uint32_t)indices_data.size(), 1, 0, 0, 0);
