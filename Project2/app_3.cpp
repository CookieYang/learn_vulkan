...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_3*>(glfwGetWindowUserPointer(window));
...
bool app_3::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_3::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_3::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_3::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_3::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
bool app_3::isSuitableDevice(VkPhysicalDevice& device) {
...
app_3::QueueFamilyIndices app_3::findQueueFamilies(VkPhysicalDevice device) {
    app_3::QueueFamilyIndices indices_ret;
...
void app_3::createLogicalDevice() {
...
bool app_3::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_3::SwapChainSupportDetails app_3::querySwapChainSupport(VkPhysicalDevice device) {
    app_3::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_3::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_3::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_3::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_3::createGraphicsPipeline() {
...
VkShaderModule app_3::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_3::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_3::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_3::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void app_3::createCommandBuffer() {
...
void app_3::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
