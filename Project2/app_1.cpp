...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_1*>(glfwGetWindowUserPointer(window));
...
bool app_1::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_1::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_1::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_1::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_1::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
bool app_1::isSuitableDevice(VkPhysicalDevice& device) {
...
app_1::QueueFamilyIndices app_1::findQueueFamilies(VkPhysicalDevice device) {
    app_1::QueueFamilyIndices indices_ret;
...
void app_1::createLogicalDevice() {
...
bool app_1::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_1::SwapChainSupportDetails app_1::querySwapChainSupport(VkPhysicalDevice device) {
    app_1::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_1::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_1::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_1::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_1::createGraphicsPipeline() {
...
VkShaderModule app_1::createShaderModule(const std::vector<char>& code) {
...
void app_1::createCommandBuffer() {
...
void app_1::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
