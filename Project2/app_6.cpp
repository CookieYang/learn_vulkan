...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_6*>(glfwGetWindowUserPointer(window));
...
bool app_6::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_6::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_6::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_6::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_6::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
void app_6::updateUniformBuffer(uint32_t currentImage) {
...
bool app_6::isSuitableDevice(VkPhysicalDevice& device) {
...
app_6::QueueFamilyIndices app_6::findQueueFamilies(VkPhysicalDevice device) {
    app_6::QueueFamilyIndices indices_ret;
...
void app_6::createLogicalDevice() {
...
bool app_6::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_6::SwapChainSupportDetails app_6::querySwapChainSupport(VkPhysicalDevice device) {
    app_6::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_6::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_6::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_6::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_6::createDescriptorSetLayout() {
...
void app_6::createDescriptorPool() {
...
void app_6::createDescriptorSets() {
...
void app_6::createGraphicsPipeline() {
...
VkShaderModule app_6::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_6::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_6::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_6::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void app_6::createUniformBuffers() {
...
void app_6::createCommandBuffer() {
...
void app_6::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
