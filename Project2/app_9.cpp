...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_9*>(glfwGetWindowUserPointer(window));
...
VkFormat app_9::findSupportedFormat(const std::vector<VkFormat>&
...
VkFormat app_9::findDepthFormat() {
...
bool app_9::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_9::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_9::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_9::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_9::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
void app_9::updateUniformBuffer(uint32_t currentImage) {
...
bool app_9::isSuitableDevice(VkPhysicalDevice& device) {
...
app_9::QueueFamilyIndices app_9::findQueueFamilies(VkPhysicalDevice device) {
    app_9::QueueFamilyIndices indices_ret;
...
void app_9::createLogicalDevice() {
...
bool app_9::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_9::SwapChainSupportDetails app_9::querySwapChainSupport(VkPhysicalDevice device) {
    app_9::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_9::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_9::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_9::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_9::createDescriptorSetLayout() {
...
void app_9::createDescriptorPool() {
...
void app_9::createDescriptorSets() {
...
void app_9::createGraphicsPipeline() {
...
VkShaderModule app_9::createShaderModule(const std::vector<char>& code) {
...
uint32_t app_9::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_9::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_9::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
...
VkCommandBuffer app_9::beginSingleTimeCommands() {
...
void app_9::endSingleeTimeCommands(VkCommandBuffer commandBuffer) {
...
void app_9::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
...
void app_9::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void app_9::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView app_9::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void app_9::createTextureImageView() {
    textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB,VK_IMAGE_ASPECT_COLOR_BIT);
}

void app_9::createTextureSampler() {
...
void app_9::createDepthResources() {
...
void app_9::createUniformBuffers() {
...
void app_9::createCommandBuffer() {
...
void app_9::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
