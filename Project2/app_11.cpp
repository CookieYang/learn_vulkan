...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    auto app = reinterpret_cast<app_11*>(glfwGetWindowUserPointer(window));
...
VkFormat app_11::findSupportedFormat(const std::vector<VkFormat>&
...
VkFormat app_11::findDepthFormat() {
...
VkSampleCountFlagBits app_11::getMaxUsableSampleCount() {
...
bool app_11::checkValidationLayerSupport() {
    uint32_t layerCount;
...
VkResult app_11::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
...
void app_11::DestroyDebugUtilsMessengerEXT(VkInstance instance, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT pDebugMessenger) {
...
void  app_11::generateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& info) {
...
void  app_11::createDebugMessenger() {
    VkDebugUtilsMessengerCreateInfoEXT createInfo{};
    generateDebugMessengerCreateInfo(createInfo);
...
void app_11::updateUniformBuffer(uint32_t currentImage) {
...
void app_11::clean() {
    ...
    vkFreeMemory(device, msaaImageMem, nullptr);
...
bool app_11::isSuitableDevice(VkPhysicalDevice& device) {
...
void app_11::selectPhysicDevice() {
...
app_11::QueueFamilyIndices app_11::findQueueFamilies(VkPhysicalDevice device) {
    app_11::QueueFamilyIndices indices_ret;
...
void app_11::createLogicalDevice() {
...
bool app_11::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
app_11::SwapChainSupportDetails app_11::querySwapChainSupport(VkPhysicalDevice device) {
    app_11::SwapChainSupportDetails details;
...
VkSurfaceFormatKHR app_11::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR app_11::choosePresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D app_11::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void app_11::createRenderPass() {
    ...
    msaaAttachmentResolveRef.attachment = 2;
    ...
    std::array<VkAttachmentDescription, 3> attachments = {colorAttachment, depthAttachment, msaaAttachmentResolve};
...
void app_11::createDescriptorSetLayout() {
...
void app_11::createDescriptorPool() {
...
void app_11::createDescriptorSets() {
...
void app_11::createGraphicsPipeline() {
...
VkShaderModule app_11::createShaderModule(const std::vector<char>& code) {
...
void app_11::createFramebuffers() {
...
uint32_t app_11::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void app_11::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void app_11::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
...
VkCommandBuffer app_11::beginSingleTimeCommands() {
...
void app_11::endSingleeTimeCommands(VkCommandBuffer commandBuffer) {
...
void app_11::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) {
...
void app_11::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void app_11::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView app_11::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) {
...
void app_11::createTextureImageView() {
    textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB,VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
}

void app_11::createTextureSampler() {
...
void app_11::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t width, int32_t height, uint32_t mipLevels) {
...
void app_11::createTextureImage() {
...
void app_11::createDepthResources() {
...
void app_11::createMsaaResource() {
    VkFormat msaaFormat = swapChainImageFormat;
    createImage(swapChainExtent.width, swapChainExtent.height, 
    1, msaaSamples, msaaFormat, VK_IMAGE_TILING_OPTIMAL,
    VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT,
     VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
    msaaImage, msaaImageMem);
    msaaImageView = createImageView(msaaImage, msaaFormat, 
    VK_IMAGE_ASPECT_COLOR_BIT, 1);
}

void app_11::loadModel() {
...
void app_11::createVertexBuffer() {
...
void app_11::createUniformBuffers() {
...
void app_11::createCommandBuffer() {
...
void app_11::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
    VkCommandBufferBeginInfo beginInfo{};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    beginInfo.flags = 0;
